...
class AuthorizationWindowFunctionality(QMainWindow, FileManager):
    def __init__(self):
        super(AuthorizationWindowFunctionality, self).__init__()
    ...
    def enter_password(self):
        ...
        if self.checking_for_file_existence('Database', f'{db_name}.db'):
    ...
    def customize_eye_button(self, icon_file):
        ...
        self.window_4.btn_eye.setIcon(icon)
...
class Ui_Window_4_authorization(object):
    def setupUi(self, Window_4_authorization):
        ...
        self.btn_eye.setStyleSheet("QToolButton {\n"
                                   ...
                                   "}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap('icons/eye_2.png'), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
