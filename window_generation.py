...
from window_9_db_interior import DatabaseInteriorWindowFunctionality as win_9
...
class GeneratingWindowFunctionality(QMainWindow):

        def __init__(self):
            super(GeneratingWindowFunctionality, self).__init__()
        ...
        def create_new(self, lenght, characters):
            """
        ...
        def get_entropy(self, lenght, character_number):
            """
        ...
        def customize_eye_button(self, icon_file):
            icon2 = QtGui.QIcon()
            icon2.addPixmap(QtGui.QPixmap(icon_file), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
            self.window_G.btn_eye.setIcon(icon2)
