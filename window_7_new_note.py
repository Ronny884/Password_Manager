...
class CreateAndEditNoteWindowFunctionality(QMainWindow):
    """
    ...
    def __init__(self):
        super(CreateAndEditNoteWindowFunctionality, self).__init__()
    ...
    def set_default_state(self):
        ...
        if self.window__1 is None or self.window__1.road_map_list == [] or self.window__1.road_map_list[-1] == 5:
            ...
            self.tuple_with_need_name_and_password = (True, self.window__9.working_db_name, self.window__9.password_for_encryption)
            ...
            self.path = f'{os.getcwd()}/Database/{self.window__9.working_db_name}.db'
            self.tuple_with_need_name_and_password = (True, self.window__9.working_db_name, self.window__9.password_for_encryption)
            self.password_for_encryption = self.window__9.password_for_encryption
            ...
            self.window_7.enter_username.setText(self.db.select_parameter_for_copy(self.path,
                                                                                   self.window__10.main_note_name,
                                                                                   'username'))
            self.window_7.enter_password.setText(self.db.select_parameter_for_copy(self.path,
                                                                                   self.window__10.main_note_name,
                                                                                   'password'))
            self.window_7.enter_login.setText(self.db.select_parameter_for_copy(self.path,
                                                                                self.window__10.main_note_name,
                                                                                'login'))
            self.window_7.enter_passphrase.setText(self.db.select_parameter_for_copy(self.path,
                                                                                     self.window__10.main_note_name,
                                                                                     'passphrase'))
            self.window_7.enter_phone_number.setText(self.db.select_parameter_for_copy(self.path,
                                                                                       self.window__10.main_note_name,
                                                                                       'phone_number'))
            self.window_7.enter_URL.setText(self.db.select_parameter_for_copy(self.path,
                                                                              self.window__10.main_note_name,
                                                                              'url'))
            ...
            self.window_7.enter_choose_category.setCurrentText(
                self.db.select_parameter_for_copy(self.path,
                                                  self.window__10.main_note_name,
                                                  'category'))
        ...
        self.customize_eye_button('icons/eye_2.png', "password_eye")
        self.customize_eye_button('icons/eye_2.png', "login_eye")
        self.customize_eye_button('icons/eye_2.png', "passphrase_eye")
        self.window_7.enter_password.setEchoMode(QLineEdit.EchoMode.Normal)
        self.window_7.enter_login.setEchoMode(QLineEdit.EchoMode.Normal)
        self.window_7.enter_passphrase.setEchoMode(QLineEdit.EchoMode.Normal)
    ...
    def add_note(self):
        ...
        if self.window__1.road_map_list[-1] in [5, 9]:
            path = f'{os.getcwd()}/Database/{target_db_name}.db'
            if self.db.repition_chek(path, name):
                # self.db.add_new_note_to_target_db(target_db_name, query_values)
                self.db.add_new_note_to_target_db(path, query_values)
            ...
            path_for_update = f'{os.getcwd()}/Database/{target_db_name}.db'
            self.db.update_note(path_for_update, query_values)
            self.window__1.road_map_list.append(7)
    ...
    def return_to_start(self):
        if self.string_checking_and_confirmation():
            # self.set_default_state()
            self.window__1.road_map_list.append(7)
            self.crypto.encrypt_file(self.tuple_with_need_name_and_password[1], self.tuple_with_need_name_and_password[2])
            self.tuple_with_need_name_and_password = False, None, None
            self.window__1.show()
            self.close()
    ...
    def customize_eye_button(self, icon_file, key):
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(icon_file), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        if key == "password_eye":
            self.window_7.eye_password.setIcon(icon)
        elif key == "login_eye":
            self.window_7.eye_login.setIcon(icon)
        else:
            self.window_7.eye_passphrase.setIcon(icon)
    ...
    def hide_or_show_text(self, line_edit):
        ...
        if state_key is not None:
            ...
            if state == False:
                ...
                self.customize_eye_button('icons/eye.png', state_key)
                setattr(self, state_key, True)
            else:
                line_edit.setEchoMode(QLineEdit.EchoMode.Normal)
                self.customize_eye_button('icons/eye_2.png', state_key)
